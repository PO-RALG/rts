...
def find_nearby_points(target_lat, target_lon, max_distance=500):
    ...
    for signal in signals:
        ...
        if distance <= max_distance:
            nearby_points.append({
                ...
                'distance': distance  # Include distance in the result
            })

    # Sort the nearby_points list based on distance
